...
Particularly in high-dimensional spaces, data can more easily be separated linearly and the simplicity of classifiers such as naive Bayes and linear SVMs
...
if single_test:
    classifiers = [MLPClassifier(alpha=1,activation='tanh', hidden_layer_sizes=(5,1),max_iter=10000)]
...
for ds_cnt, ds in enumerate(datasets):
    ...
    cm = plt.cm.RdBu
    cm_bright = ListedColormap(['#FF0011', '#1100FF'])
